//This code might look intimidating, but try playing with the code.
...
var CEM_settings = {
	...
	polygon_radius: 200, //size of the tile
	image_path: "./assets/rainbow.jpg" //image url if this tarts with a ./ it will be relative to the current directory
};
